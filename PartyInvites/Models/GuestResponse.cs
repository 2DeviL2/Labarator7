...
namespace PartyInvites.Models
{
    public class GuestResponse
    {
        ...
        {
            string str = System.Configuration.ConfigurationManager.ConnectionStrings["Labar7BD"].ConnectionString;
            using (SqlConnection con = new SqlConnection(str))
            {
                SqlCommand com1 = new SqlCommand("SELECT * FROM Guest WHERE Email='" + Email + "' ", con);
                ...
                if (r1.HasRows)
                {
                    ...
                    SqlCommand com2 = new SqlCommand("Update Guest set Name=@Name,Phone=@Phone,WillAttend=@WillAttend where Email=@Email", con);
                ...
                else
                {
                    ...
                    SqlCommand com = new SqlCommand("Insert into Guest (Name,Email,Phone,WillAttend) values (@Name,@Email,@Phone,@WillAttend)", con);
